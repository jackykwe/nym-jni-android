...
use crate::clients_native_src::client::config::SocketType;
use crate::clients_native_src::websocket;

use self::config::ConfigAndroid;

// ? Changed from `pub(crate) -> pub`
pub mod config;

// ? Copied wholesale same except `Config -> ConfigAndroid`
pub struct NymClientAndroid {
