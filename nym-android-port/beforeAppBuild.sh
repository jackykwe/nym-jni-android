...
cd ../nym-jni || exit 2
cargo build --color always --target aarch64-linux-android --features debug_logs || exit 3
#cargo build --color always --target x86_64-linux-android --features debug_logs || exit 4
